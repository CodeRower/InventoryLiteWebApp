(function (app) {
    ...
    purchaseCtrl.$inject = ['$scope', '$location', '$routeParams', 'apiService', 'notificationService', '$timeout'];

    var childWindowObject=null;

  
    function purchaseCtrl($scope, $location, $routeParams, apiService, notificationService, $timeout) {
